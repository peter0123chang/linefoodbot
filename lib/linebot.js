...
function getQuestions() {
  ...
  sheets.spreadsheets.values.get({auth:oauth2Client,spreadsheetId:mySheetId,range:encodeURI('QNA')},function(err,response){if(err){console.log(sheets+'讀取問題檔的API產生問題：' + err);return;}
