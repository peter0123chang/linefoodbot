...
req.body = {
	events: [{
		...
		source: {
			type: 'user',
			userId: 'U7f6e8a8cb25038f5e166473f0ee2328b'
		},
		message: {
			id: '325708',
			type: 'text',
...
describe('linefoodbot', function () {
	describe('#constructor()', function () {
		it('should create a new LineFoodBot instance.', function () {
			assert.equal(linefoodbot.LineFoodBot, bot.constructor);
		});
